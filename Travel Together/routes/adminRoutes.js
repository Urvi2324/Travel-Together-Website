...
router.post("/addHotel", uploadMiddleware("uploads/hotels/"), async (req, res) => {
    try {
        ...
        const newHotel = new Hotel({
            ...
            rating: parseFloat(hotelData.rating), // Convert rating to float
            ...
            priceRange: [parseFloat(hotelData.priceRange[0]), parseFloat(hotelData.priceRange[1])], // Convert priceRange to float
            images: images,
            rooms: rooms,
        });
